          ...
          /* // 创建Session实例对象
            Authenticator auth = new Authenticator() {
                public PasswordAuthentication getPasswordAuthentication() {
                    // 密码验证
                    return new PasswordAuthentication(paramUtil.getSendMailUsername(), paramUtil.getSendMailPassword());
            ...
            // 设置发件人
            message.setFrom(new InternetAddress(paramUtil.getSendMailPerson()));
            // 设置邮件主题
